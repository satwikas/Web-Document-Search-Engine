...
- Manning, C. D., Raghavan, P., & Schütze, H. (2009). Introduction to Information Retrieval (Vol. 3). Cambridge University Press. (ACM Style)
- Baeza-Yates, R., Ribeiro-Neto, B., Barreto, M. C., & Moffat, A. (2011). Modern Information Retrieval: The Equations Behind Web Search (2nd ed.Addison-Wesley. (AMS/AIP Style)
- Sebastiani, F. (2002). Machine learning in automated text categorization. ACM Computing Surveys (CSUR) , 34(1), 1-47. (IEEE Style)
- Aksyonoff, M. (2020). Scrapy - A Fast High-Level Web Crawling & Web Scraping Framework for Python. Retrieved from https://scrapy.org/.
- Pedregosa, F., Varoquaux, G., Gramfort, A., Michel, V., Thirion, B., Grisel, O., ... & Vanderplas, J. (2011). Scikit-learn: Machine Learning in Python. Journal of Machine Learning Research, 12, 2825-2830.
- Ronacher, A. (2020). Flask - A Lightweight WSGI Web Application Framework. Retrieved from https://flask.palletsprojects.com/.
